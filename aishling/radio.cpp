...
// TODO: Move this to program memory
//uint8_t si4463_setup_data[] PROGMEM = {
uint8_t si4463_setup_data[] = {
    ...
    0x10, CMD_SET_PROPERTY, GRP_MODEM, 0x0C, 0x00,
        ...
        0x07, // MODEM_DSM_CTRL
        0x01, 0x38, 0x80, // MODEM_DATA_RATE
        0x05, 0xC9, 0xC3, 0x80, // MODEM_TX_NCO_MODE
    ...
    0x10, CMD_SET_PROPERTY, GRP_MODEM, 0x0C, 0x00,
        ...
        0x00, // MODEM_MAP_CONTROL
        0x07, // MODEM_DSM_CTRL
        0x05, 0xDC, 0x00, // MODEM_DATA_RATE
        0x05, 0xC9, 0xC3, 0x80, // MODEM_TX_NCO_MODE
        0x00, 0x01, // MODEM_FREQ_DEV
    0x05, CMD_SET_PROPERTY, GRP_MODEM, 0x01, 0x0C,
        0xF7, // MODEM_FREQ_DEV
    0x0B, CMD_SET_PROPERTY, GRP_MODEM, 0x07, 0x19,
        0x80,// MODEM_MDM_CTRL
        0x08, // MODEM_IF_CONTROL
        0x02, 0x80, 0x00, // MODEM_IF_FREQ
        0x70, // MODEM_DECIMATION_CFG1
        0x20, // MODEM_DECIMATION_CFG0
    0x0D, CMD_SET_PROPERTY, GRP_MODEM, 0x09, 0x22,
        0x00, 0x62, // MODEM_BCR_OSR
        0x05, 0x3E, 0x2D, // MODEM_BCR_NCO_OFFSET
        0x02, 0x9D, // MODEM_BCR_GAIN
        0x00, // MODEM_BCR_GEAR
        0xC2, // MODEM_MISC_1
    0x0B, CMD_SET_PROPERTY, GRP_MODEM, 0x07, 0x2C,
        0x54, // MODEM_AFC_GEAR
    ...
    0x0B, CMD_SET_PROPERTY, GRP_SYNTH, 0x07, 0x00,
        ...
        0x03, // SYNTH_LPFILT0
    0x0C, CMD_SET_PROPERTY, GRP_FREQ_CONTROL, 0x08, 0x00,
        0x3F,// FREQ_CONTROL_INTE
        0x0E, 0x51, 0xEB, // FREQ_CONTROL_FRAC
        0x28, 0xF6, // FREQ_CONTROL_CHANNEL_STEP_SIZE
        0x20, // FREQ_CONTROL_W_SIZE
        0xFA,// FREQ_CONTROL_VCOCNT_RX_ADJ
    0x00
...
void radio_setup() {
    ...
    while (*data) {
        int len = *data++;
        //memcpy_P(cmd, data, len);
        //si4463_cmd(len, cmd, 0, NULL);
